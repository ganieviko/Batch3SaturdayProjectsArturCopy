package Project17.solutionByTurkana;
...
//    Login by the credentials (username = "daulet2030@gmail.com" and password = "TechnoStudy123@")
    ...
    public void navigate() {
        ...
        driver.findElement(Selector.firstname).sendKeys("Turkana");
        wait.until(ExpectedConditions.visibilityOfElementLocated(Selector.lastname));
        driver.findElement(Selector.lastname).sendKeys("Mammadova");

        driver.findElement(Selector.genderselect).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(Selector.gender2));
        driver.findElement(Selector.gender2).click();

        driver.findElement(Selector.gradeselect).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(Selector.grade1));
        driver.findElement(Selector.grade1).click();
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(Selector.section1));
        driver.findElement(Selector.section1).click();
 ...
 */
    ...
    @Test(dependsOnMethods = "navigate",dataProvider ="DataProvider" )
